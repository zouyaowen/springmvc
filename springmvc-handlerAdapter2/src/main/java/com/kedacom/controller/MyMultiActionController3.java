...
public class MyMultiActionController3 extends MultiActionController {
	//此处使用第三种方法名解析器ParameterMethodNameResolver
	...
	public ModelAndView doFirst(HttpServletRequest request,HttpServletResponse response){
		...
		System.out.println("执行MyMultiActionController3的doFirst方法");
		modelAndView.setViewName("/index.html");
		return modelAndView;
	}
	public ModelAndView doSecond(HttpServletRequest request,HttpServletResponse response){
		ModelAndView modelAndView = new ModelAndView();
		System.out.println("执行MyMultiActionController3的doSecond方法");
		modelAndView.setViewName("/index.html");
		return modelAndView;
	}
}
